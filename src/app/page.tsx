    ...
    <div className="">
      ...
      <main className='top-20 absolute w-full'>
        <div ref={app} className='flex flex-col justify-center items-center box-border h-[calc(100vh-80px)] text-center'>
          ...
          <button className='border border-white hover:bg-white hover:text-black py-3 px-20 mt-24 opacity-0'>Explore</button>
          <div className='flex gap-5 mt-24'>
            <div className='border border-white rounded-2xl px-2 py-1 hover:bg-white hover:text-black opacity-0'>UI/UX Design</div>
            <div className='border border-white rounded-2xl px-2 py-1 hover:bg-white hover:text-black opacity-0'>Frontend Development</div>
            <div className='border border-white rounded-2xl px-2 py-1 hover:bg-white hover:text-black opacity-0'>Wordpress Development</div>
            <div className='border border-white rounded-2xl px-2 py-1 hover:bg-white hover:text-black opacity-0'>MERN Stack</div>
            <div className='border border-white rounded-2xl px-2 py-1 hover:bg-white hover:text-black opacity-0'>Django Stack</div>
          </div>
        </div>
